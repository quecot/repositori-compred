...
const dummyResources: Resource[] = [
  {
    id: "0",
    description: '"Descripció del recurs aquí"',
    title:
      "Planteamiento del problema de investigación: desde la óptica cuantitativa y cualitativa",
    type: "Llibre",
  ...
  },
  {
    ...
    description: '"Descripció del recurs aquí"',
    title:
      "¿Cómo escoger un tema de investigación y construir una pregunta de investigación?",
    type: "Article",
    dimension: "Planificació de la recerca",
    subdimension: "Elecció del tema i pregunta de recerca",
    level: 1,
  ...
  },
  {
    ...
    description: '"Descripció del recurs aquí"',
    title:
      "Cerca i gestió de la informació: les principals fonts d'informació en Educació, Psicologia i Logopèdia",
    type: "Presentació",
    dimension: "Fonamentació teòrica",
    subdimension: "Eines per cercar informació",
    level: 1,
